...
function fun(ID)
{
	...
	switch(ID)
	{
		...
		case "b1":
			$('#Text1').text('LIFE COIN EXCHANGE');
			$('#Text2').text('RACKET BOONS');
			...
			break;
		case "b2":
			$('#Text1').text('WHISPER BROKERS');
			$('#Text2').text('RACKET BOONS');
			$('#Text3').html("<strong>Special:</strong> If the gang also controls one of the Linked Rackets, when challenged, the gang may choose the Racket that will be at stake in the battle, even though it would normally be chosen by the challenger.");
			$("#Text4").text("");
			$("#Text5").text("ENHANCED BOONS");
		...
		case "b3":
			...
			break;
		case "b4":
			$('#Text1').text('PEDDLERS OF FORBIDDEN LORE');
			$('#Text2').text('RACKET BOONS');
		...
		case "b6":
			...
			break;
		case "b7":
			$('#Text1').text('THE RESSURECTION GAME');
			$('#Text2').text('RACKET BOONS');
		...
		case "b9":
			...
			break;
		case "b10":
			$('#Text1').text('OUT-HIVE SMUGGLING ROUTES');
			$('#Text2').text('RACKET BOONS');
			$('#Text3').html("<strong>Income:</strong> The gang earns D6x10 credits when they collect Income.");
			$("#Text4").text("");
			$("#Text5").text("ENHANCED BOONS");
			...
			break;
		case "b11":
			$('#Text1').text('XENOS BEAST TRAFFICKING');
			$('#Text2').text('RACKET BOONS');
		...
		case "b14":
			...
			break;
		case "b15":
			$('#Text1').text('PRODUCTION SKIMMING');
			$('#Text2').text('RACKET BOONS');
			$('#Text3').html("<strong>Income:</strong> The gang earns D6x10 credits when they collect Income.");
			$("#Text4").text("");
			$("#Text5").text("ENHANCED BOONS");
			...
			break;
		case "b16":
			$('#Text1').text('CARAVAN ROUTE CONTROL');
			$('#Text2').text('RACKET BOONS');
			$('#Text3').html("<strong>Income:</strong> The gang earns D6x10 credits when they collect Income.");
			$("#Text4").text("");
			$("#Text5").text("ENHANCED BOONS");
		...
		case "b19":
			...
			break;
		case "b20":
			$('#Text1').text('SETTLEMENT PROTECTION');
			$('#Text2').text('RACKET BOONS');
			...
			break;
		case "b21":
			$('#Text1').text('REDEMPTIONIST BACKERS');
			$('#Text2').text('RACKET BOONS');
		...
		case "b22":
			...
			break;
		case "b23":
			$('#Text1').text('ARCHAEOTECH AUTIONNING');
			$('#Text2').text('RACKET BOONS');
			...
			break;
		case "b24":
			$('#Text1').text('PROXIES OF THE OMNISSIAH');
			$('#Text2').text('RACKET BOONS');
			...
			break;
		case "b25":
			$('#Text1').text('PROMETIUM GUILD BOND');
			$('#Text2').text('RACKET BOONS');
			$('#Text3').html("<strong>Special:</strong> Whilst it controls this Racket, the gang can control no other Guild Bond Racket.");
			$("#Text4").text("");
			$("#Text5").text("");
		...
		case "b27":
			...
			break;
		case "b28":
			$('#Text1').text('SLUDGE SEE');
			$('#Text2').text('TERRITORY BOONS');
		...
		case "b30":
			...
			break;
		case "b31":
			$('#Text1').text('REFUSE DRIFT (CAWDOR)');
			$('#Text2').text('TERRITORY BOONS');
		...
		case "b33":
			...
			break;
		case "b34":
			$('#Text1').text('DRINKING HOLE (DELAQUE)');
			$('#Text2').text('TERRITORY BOONS');
			...
			break;
		case "b35":
			$('#Text1').text('GAMBLING DEN (DELAQUE)');
			$('#Text2').text('TERRITORY BOONS');
			$('#Text3').html("<strong>Reputation</strong>  Whilst it controls this Territory, the gang adds +1 to its Reputation.");
			...
			break;
		case "b36":
			$('#Text1').text('NEEDLE WAYS (DELAQUE)');
			$('#Text2').text('TERRITORY BOONS');
			...
			break;
		case "b37":
			$('#Text1').text('STINGER MOULD SPRAWL (ESCHER)');
			$('#Text2').text('TERRITORY BOONS');
			...
			break;
		case "b38":
			$('#Text1').text('MINE WORKINGS (ORLOCK)');
			$('#Text2').text('TERRITORY BOONS');
		...
		case "b39":
			...
			break;
		case "b40":
			$('#Text1').text('TOLL CROSSING (ORLOCK)');
			$('#Text2').text('TERRITORY BOONS');
			...
			break;
		case "b41":
			$('#Text1').text('GENERATORIUM (VAN SAAR)');
			$('#Text2').text('TERRITORY BOONS');
			...
			break;
		case "b42":
			$('#Text1').text('TECH BAZAAR (VAN SAAR)');
			$('#Text2').text('TERRITORY BOONS');
			...
			break;	
		case "b43":
			$('#Text1').text('ARCHAEOTECH DEVICE (VAN SAAR)');
			$('#Text2').text('TERRITORY BOONS');
